    ...
    <div class='project-row'>
        <div class='project-tile'>
            <div id='kdanse' class='project-desc animate'>
                <p>
                    <?php echo lang("projet_lang.autre"); ?>
                </p>
                <a class='project-btn is-forbidden' >
        ...
        <div class='project-tile'>
            <div id='mcu' class='project-desc animate'>
                ...
                <a target='blank' class='project-btn' href='https://portfolio.valentin-moreau.fr/mcu-timeline/'>
                    <?php echo lang("projet_lang.lien"); ?>
                </a>
            </div>
        </div>
    ...
    <div class='project-row'>
        ...
        <div class='project-tile '>
            <div id='cv' class='project-desc animate '>
                ...
                <a target='blank' class='project-btn' href='https://portfolio.valentin-moreau.fr/CV_Bulma/'>
                    <?php echo lang("projet_lang.lien"); ?>
                </a>
            </div>
        </div>
