...
<div class='content-box'>
    ...
    <div class='info'>
        ...
        <h2><?php echo lang("apropos_lang.text"); ?></h2>
        <a target='blank' href='<?php echo base_url(); ?>/assets/FILES/<?php echo lang("apropos_lang.lienCV"); ?>' class='btn-main'><?php echo lang("apropos_lang.btn_cv"); ?></a>
    </div>
    ...
    <div>
        ...
        <div class='etiquette-box'>
            <!-- List Title  -->
            <span class='etiquette'><?php echo lang("apropos_lang.outil"); ?></span>
            ...
            <div class='list-container'>
                <div class='animate'>
                    <img class='icon' src='<?php echo base_url(); ?>/assets/ICON/icon-xd.svg' alt='adobe xd'>
                    <p class='desc'>Adobe XD</p>
                </div>
                <a class='animate'>
                    <img class='icon' src='<?php echo base_url(); ?>/assets/ICON/icon-illustrator.svg' alt='adobe ai'>
                    <p class='desc'>Adobe Illustrator</p>
                </a>
                <a class='animate'>
                    <img class='icon' src='<?php echo base_url(); ?>/assets/ICON/icon-photoshop.svg' alt='adobe ps'>
                    <p class='desc'>Adobe Photoshop</p>
                </a>
            </div>
            <!-- List Title: Reseau  -->
            <span class='etiquette'><?php echo lang("apropos_lang.reseau"); ?></span>
            <!-- content of the list  -->
            <div class='list-container'>
                <a class='animate'  >
