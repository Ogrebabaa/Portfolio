...
<!-- LINK ============================================================= -->
<link rel="shortcut icon" href="<?php echo base_url("/assets/IMG/logo-HQ-With-Border.svg"); ?>">
...
<body>
    ...
    <script>
        ...
        particlesJS.load("particles-js", "https://valentin-moreau.fr/particles.json", function () {
